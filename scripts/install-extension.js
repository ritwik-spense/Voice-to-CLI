...
for (const editor of editors) {
  try {
    execSync(`${editor} --install-extension "${vsixPath}" --force`, { stdio: "inherit" });
    installed = true;
  } catch {}
}

if (!installed) {
  console.error("❌ Failed. Make sure 'code' or 'kiro' is in your PATH.");
  process.exit(1);
}
...
console.log("Usage: Press Ctrl+Shift+Space to start/stop voice recording.");
